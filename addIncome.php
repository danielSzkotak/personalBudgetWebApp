...
<head>
   ...
   <?php if(isset($_SESSION['inputSuccess'])){
      echo "
      <script>
               ...
               <div class="col ms-lg-5 mt-5 mt-lg-0">
                  ...
                  <form action="includes/addIncome.inc.php" method="POST" class="needs-validation" id="addIncomeForm" novalidate>
                     <div class="mb-3 mt-5">
                        ...
                        <input type="number" name="incomeAmount" class="form-control fs-5 pt-3 pb-3 shadow-none" id="inputExpense1" step="any" min="0.01" required>
                     </div>
                     <div class="mb-3">
